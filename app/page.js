...
export default async function Home() {
  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="space-y-24 mt-24">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p>Express yourself with out powerful editor featuring:</p>
          ...
          <div className="space-y-4 bg-white rounded-xl shadow-xl p-6 border border-orange-100">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p>Track your emotional journey with owerful analytics:</p>
      ...
      {/* FAQs Section  */}
      <div className="mt-24">
        <h2 className="text-3xl text-red-900 font-bold text-center mb-12">
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className='p-12 text-center'>
            <h2
              className="text-3xl text-red-900 font-bold mb-6"
            >
              Start Reflect-ing on Your journey Toady 
            </h2>
